...
- (id)initWithFilePath:(NSString *)filePath
{
    if ((self = [super init])) {
        ...
        if(!_dataStore){
            ...
            NSString *projectName = [[[filePath lastPathComponent] componentsSeparatedByString:@"."] firstObject];
            
            _filePath  = [projectDir stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.xcodeproj",projectName]];
            _dataStore = [[NSMutableDictionary alloc]
                          initWithContentsOfFile:[_filePath stringByAppendingPathComponent:@"project.pbxproj"]];
